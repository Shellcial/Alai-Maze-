...
public static class LeanTweenExt
{
    ...
    //LeanTween.alphaTMProText
    public static LTDescr LeanAlphaText(this TMP_Text tMP_Text, float to, float time)
    {
        var _color = tMP_Text.color;
        var _tween = LeanTween
            .value(tMP_Text.gameObject, _color.a, to, time)
